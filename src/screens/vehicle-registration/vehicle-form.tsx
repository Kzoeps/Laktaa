		...
		<>
			...
			>
				{(formik: FormikProps<VehicleInfo>) => (
					<>
						<FMSelectInput formik={formik as unknown as FormikProps<FormikValues>} name='vehicleType'
													 options={[...VEHICLE_TYPE_OPTIONS]} placeholder='Vehicle Type' />
						<FMTextInput label='Model' formik={formik as unknown as FormikProps<FormikValues>} name='carModel' />
					</>
				)}
			</Formik>
		</>
